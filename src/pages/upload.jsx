                    ...
                    <div className="row g-3">
                        ...
                        <div className={`row ${styleLabel.rowAlign}`}>
                            ...
                            <div className="col-md-11">
                                <input type="text" className="form-control" id="inputProName" required minLength="0" maxLength="30" placeholder="상품 제목을 입력하세요."
                                    value={(isModify && itemInfo.productName) ? itemInfo.productName : ""}
                                    onChange={(e) => {
                                        lengthCheck(e)
                        ...
                        <div className="col-md-4">
                            <label htmlFor="inputAddress" className="form-label">카테고리<span className="text-danger">*</span></label>
                        ...
                        <div className="col-md-3">
                            <label htmlFor="inputAddress" className="form-label">지역<span className="text-danger">*</span></label>
                        ...
                        </div>
                        {
                            ...
                            <div className="col-md-2">
                                <label htmlFor="inputState" className="form-label">상태<span className="text-danger">*</span></label>
                                <select id="inputState" className="form-select">
                                    <option defaultValue>판매중</option>
                                    <option>예약중</option>
                                    <option>판매완료</option>
                                </select>
                            </div>
                        ...
                        <div className={styleLabel.h1}></div>
                        <div className={`col-md-3`}>
                            <label htmlFor="inputCity" className="form-label">가격<span className="text-danger">*</span></label>
                        ...
                        <div className="col-12">
                            <label htmlFor="inputContent" className="form-label">상세설명<span className="text-danger">*</span></label>
